...
const Stats: React.FC<{ collection: Collection }> = ({ collection }) => {
  ...
  return (
    <div className="flex items-end justify-between w-full pl-8 space-x-4">
      <div className="flex flex-col items-center justify-between bg-white rounded-md shadow-md flex-1 py-2">
